...
RUN mvn -pl incident-service -am dependency:go-offline -B
COPY incident-service/src incident-service/src
RUN mvn clean package -pl incident-service -am -DskipTests
